...
<body class="bg-gradient-to-b from-[#141B46] to-[#3143AC] text-white font-sans">
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 overflow-y-auto">
            ...
            <!-- Breadcrumb -->
            <div class="text-gray-400 mb-6">HOME / PERKULIAHAN / <span class="text-yellow-400">JADWAL</span></div>
            <!-- Content -->
            <div>
                <h1 class="text-2xl font-bold mb-4">Jadwal</h1>
                <!-- Jadwal Grid -->
                <div class="grid grid-cols-3 gap-4 mb-8">
                    <a href="/kaprodi/buatjadwalbaru" class="bg-orange-500 p-6 rounded-lg relative">
                    ...
                    <a href="/kaprodi/lihatjadwal" class="bg-orange-500 p-6 rounded-lg relative">
                        <span class="absolute top-2 right-2 text-white"><i class="fas fa-heart"></i></span>
