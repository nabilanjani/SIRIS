...
<body class="bg-gradient-to-b from-gray-800 to-blue-900 text-white font-sans">
    <div class="flex h-screen">
        ...
        <div class="w-1/5 bg-gradient-to-b from-gray-900 to-gray-800 p-6">
            ...
            <nav class="space-y-4">
                <a href="/bagianakademik/dashboard" class="flex items-center space-x-2 text-white-400 hover:text-white py-2 px-4 active:font-bold ">
                    <i class="fas fa-home"></i>
                    <span>Dashboard</span>
                </a>
                <a href="/bagianakademik/perkuliahanba" class="flex items-center space-x-2 text-gray-400 hover:text-white py-2 px-4 active:font-bold">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="bg-gray-700 p-6 rounded-lg mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <div class="text-xl font-bold">Ahmad Brian, S. Kom</div>
                        <div class="text-gray-400">NIP: 197203171998021111</div>
                        <div class="text-gray-400">Tenaga Pendidik | <span class="text-green-400">Informatika S1</span></div>
                    </div>
